...
-(void)addCustomElements
{
	...
	UIImage *btnImage = [UIImage imageNamed:@"NavBar_02.png"];
	UIImage *btnImageSelected = [UIImage imageNamed:@"NavBar_02_s.png"];
	
	self.btn1 = [UIButton buttonWithType:UIButtonTypeCustom]; //Setup the button
	btn1.frame = CGRectMake(0, 920, 120, 50); // Set the frame (size and position) of the button)
	...
	btn2.frame = CGRectMake(120, 920, 120, 50);
	...
	btn3.frame = CGRectMake(240, 920, 120, 50);
	...
	btn4.frame = CGRectMake(360, 920, 120, 50);
