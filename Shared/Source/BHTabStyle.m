...
- (id)init {
  if ((self = [super init])) {
    ...
    //self.selectedTabColor = [UIColor colorWithWhite:220/255.0 alpha:1];
	  self.selectedTabColor = [UIColor colorWithRed:162/255.0 green:197/255.0 blue:52/255.0 alpha:1];
    ...
    //self.unselectedTabColor = [self.selectedTabColor colorWithAlphaComponent:unselectedAlpha];
	  self.unselectedTabColor = [UIColor colorWithWhite:220/255.0 alpha:1];
